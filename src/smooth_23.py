    ...
    for line in query:
        ...
        for i in range(len(wordList)):
            ...
            for letter in targetWord:
                ...
                tarID = -1
                tarID2 = 0
                total1 = get_total(wordList[i - 1])
                total2 = get_total(wordList[i - 2])
                ...
                for id1 in dp[-1]:
                    ...
                    prob2 = prob_one(id1)
                    prob = alpha * prob1 / prob2 + (1 - alpha) * prob2 / total1
                    # 若机率比现有值大，更新
                ...
                if i >= 2:
                    for id0 in dp[-2]:
                        ...
                        for id1 in dp[-1]:
                            ...
                            # 平滑公式
                            prob = beta * (prob1 / prob2) + (1 - beta) * (alpha * prob2 / prob3 + (1 - alpha) * prob3 / total2)
                            prob *= (alpha * prob2 / prob3 + (1 - alpha) * prob3 / total2)
...
if __name__ == "__main__":
    print("Running smooth_23.py ...")
    main()
    print("Finished running smooth_23.py")
    print()